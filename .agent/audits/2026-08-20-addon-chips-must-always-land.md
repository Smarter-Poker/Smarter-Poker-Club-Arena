...
Dan, binding: *"Fix the add-on bug. It must ALWAYS award the specific amount of
chips added to the stack count when purchased. Don't worry about fixing the
$25.00 as long as the bug is fixed and we don't have that issue anymore."*
...
Fixing (1) closes the money hole but, alone, *costs those players their add-on*:
