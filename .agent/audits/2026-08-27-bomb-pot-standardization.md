...
| §10.1            | Variant override                                                 | DEFERRED — config fields exist (`baseTableVariant` unneeded: HandConfig.gameVariant is per-hand already); no UI/host surface yet | DEFERRED                                                                                                     |
