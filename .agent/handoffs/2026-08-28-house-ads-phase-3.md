...
The lesson worth keeping: on this system the event log's *absence* is usually
...
something in that rail is not reaching the table, and *that* is a real bug worth
your time.
