...
- Approved product art stays approved. In particular, the existing gold VIP
  card artwork is immutable unless Dan explicitly asks to replace it. Plan
  name, price, term, Diamond price and selection state remain live DOM text in
  the artwork's established zones.
...
- [ ] Established Marketplace layouts, routes, product art and purchase paths survived; only their actual visual parts were upgraded.
