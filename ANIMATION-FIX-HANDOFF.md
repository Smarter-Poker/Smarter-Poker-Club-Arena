...
4. `src/components/table/SeatSlot.tsx` -- 6 fixes:
   - Fold card animation (isFolding state + seat__cards--folding class)
   - Showdown 3D card flip (isShowdownFlip state + seat__cards--showdown class)
   - Deal card slide-in (isDealing prop + seat__cards--dealing class)
