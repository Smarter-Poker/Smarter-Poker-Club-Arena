...
### 🚧 NEEDS BUILDING
1. **Deal-Making (ICM Chop)** — No components exist. Need: ICM calculator, deal proposal UI, accept/decline flow
2. **Tournament Director Panel** — Runtime admin controls: pause, add time, adjust levels, kick players
3. **Disconnection Handling** — Auto-fold timer visible to player, sit-out after timeout
...
- **GitHub Token**: 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
