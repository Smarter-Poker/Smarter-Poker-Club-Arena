...
migration `20260910170336`. Their historical rows are preserved in the locked
...
- Retired automation: the database deploy dispatcher, deploy-start marker,
  ...
  `20260910170336`. Historical rows were moved to locked `ca_archive` tables.
...
- Migrations 20260902203100, 20260902204600, 20260902211500 were applied. Their
  ...
  by migration 20260910170336; the historical data remains in `ca_archive`.
...
| former deploy-start recorder | Retired | database dispatch reconciliation removed in `20260910170336` | n/a |
...
archived outside `public` by migration `20260910170336`.
...
functions are removed by migration `20260910170336`.
...
Migration `20260910170336` removes its crons and callable functions and moves
