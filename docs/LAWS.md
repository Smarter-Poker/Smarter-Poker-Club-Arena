...
| tests/both-sides-of-the-wait-say-the-same-thing.law.test.ts          | A filling seat-first game shows the same fill indicator to a spectator and to the player who paid, and invents no ETA                                            |
| -------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| -----------------------------------------------------------------    | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tests/a-paid-finish-is-not-a-bust.law.test.ts                        | A tournament place that PAID is celebrated and held like a win, not sent out through the busted door                                                             |
| Law test file                                                        | Guards                                                                                                                                                           |
| -----------------------------------------------------------------    | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tests/a-control-that-says-none-must-mean-none.law.test.ts            | UI controls labeled "none" disable the feature entirely                                                                                                          |
| tests/a-credit-line-is-spendable.law.test.ts                         | Club credit lines can actually be spent                                                                                                                          |
...
| tests/a-card-never-states-a-stack-it-has-not-drawn.law.test.ts       | A Spin card shows the stack RANGE until the wheel has turned, never the 300-chip seed, and derives no depth label from a placeholder                             |
| tests/play-again-never-lands-on-a-full-table.law.test.ts             | Play Again checks capacity before sending a player to a sibling game, and does not navigate to a filter nothing reads                                            |
