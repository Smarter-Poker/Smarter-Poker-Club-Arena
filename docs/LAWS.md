...
| tests/a-gate-that-gates-nothing.law.test.ts                       | The TOS guard actually asks, records acceptance only through the endpoint on a confirmed write, keeps the terms readable while it blocks, and has no dead twin                                    |
