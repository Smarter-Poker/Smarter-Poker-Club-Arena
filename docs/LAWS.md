...
| tests/no-auto-table-switch.law.test.ts                            | Never auto-change tables (CLAUDE.md 10.6)                                                                                                                                                         |
| tests/notifications-open-as-a-popup.law.test.ts                   | Every notifications trigger opens the full-screen popup over the current page; the /notifications route still renders the same surface for deep links (Dan 2026-09-02)                            |
