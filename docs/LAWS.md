...
| tests/unit/snapshotNeverDropsASeat.law.test.ts                  | State snapshots keep every seat                                                                                                                                                                |
| server/src/engine/TournamentChipsAreConserved.law.test.ts       | Tournament chips are conserved hand by hand: a seat credit never touches a game in progress, a hand that does not conserve is not persisted, a DB conservation refusal is never written around |
