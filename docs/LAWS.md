...
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| server/src/services/aSeatFirstBoardSellsItsSeatsOnce.law.test.ts    | Capacity counts live entrants so a departed player frees the seat, AND a started Spin or duel admits nobody                                                                                                   |
| server/src/services/theBoardAnnouncesItself.law.test.ts             | The seat that fills a seat-first board broadcasts it in the same transaction, and the engine starts on the push; the poll stays only as the backstop                                                          |
