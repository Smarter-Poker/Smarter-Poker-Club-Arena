...
| 9   | `services/sentry-autofix/` has no references (H1 C17)                                        | **Retired.** The generic error-watcher/autorepair path, its GitHub workflow, service, Vercel declaration, and active runbooks were removed. Normal Sentry reporting remains; production errors must be fixed at their source through reviewed code.                                                                                                                                        |
...
| X13 | `services/sentry-autofix/`                                                                       | Retired with its Vercel declaration, automated repair workflow, and active runbooks.                       |
