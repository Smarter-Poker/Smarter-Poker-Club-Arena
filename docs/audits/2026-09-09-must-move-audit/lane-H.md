...
| `src/pages/TablePage.tsx`                                        | 985-1000, 11490-11520, 12050-12095, 15180-15240, 22470-22530, 22880-22960, 26240-26275                                                                                           | movedToTableId, OPEN*MUST_MOVE_LOBBY bus, gameStyle read, SEAT_MOVE*\* handlers, the corner mount, the masthead rows, the modal mount                  |
...
| H10 | -           | 5 s poll: reads on open, every tick while open, nothing while closed, cleared on unmount (effect keyed on `isOpen`/`gameId`). Corner: 10 s, re-read on every SEAT*MOVE*\* event via refreshKey, cleared on unmount.                                                                                                                                                                                                                                                                                                                                                                                                                               | code read                                                                                                                                                              | No defect; pinned with fake timers                                                                                                                                                                                                                                                                                                                                                                                                                                | DONE                  |
