...
## Engine eviction ownership and legacy cron inventory
...
### Native ownership and cluster repair retirement — local implementation

See docs/changelog/2026-09-09-native-committed-game-seat-ownership.md. Native deferred uniqueness, derived scopes, FK cascades, protected backfill and guarded removal of both planner repair payments are implemented locally. 88 actual PostgreSQL cases and 137 cluster wiring/controller cases passed. Production preflight found no duplicate active ownership groups. Neither new migration has been applied or published. Phase 2 remains in progress; close/admission and adoption gates remain open.

## Native close/admission follow-up
