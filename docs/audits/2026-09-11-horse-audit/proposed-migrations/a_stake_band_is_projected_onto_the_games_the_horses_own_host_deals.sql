...
--   sit at it.
--
-- Simulated read-only with the production body (p_min_hands 1000,
-- hysteresis 5) against today's player_stats: the next assignment run would
-- write 'high' onto 38 Midway horses and 18 DSS horses. A Midway 'high' horse
...
begin
  ...
  -- this horse's host. Whatever path a horse took above, it lands on a band
  -- that has a game it can reach.
  clamped as (
