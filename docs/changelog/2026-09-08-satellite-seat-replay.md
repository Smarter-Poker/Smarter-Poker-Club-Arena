...
CI follow-up: restore the existing live-definition admission assertions in a forward-only verification migration. The applied replay migration is unchanged; the cap boundary, finalized-pool refusal, and duplicate-origin checks remain enforced.
