...
seconds, so retirement cannot wait indefinitely behind a live dependency or
leave an abandoned DDL transaction holding locks.
...
- Production lock, statement, and idle-transaction waits are bounded.
