...
Already balanced fields return their validated, copied rosters without spending the search budget or consuming random draws. This includes mixed floor/ceiling occupancies across 2,000 tables. Large unbalanced fields can still return pending when their proof budget is exhausted.
