...
The Phase 8 continuation reuses a bounded prefix of the common ICM clocks
already generated by Phase 7. It retains 128 future-hand trials, the same
deterministic estimates and the corresponding wider uncertainty. It does not
regenerate or sort remote-field clocks during the continuation. Fresh and
reused workspaces are compared on complete candidate ledgers for 3, 18, 200
and 1,000 players. The ordinary Phase 7 trial count and estimates remain
unchanged; final tables remain exact.
