...
their context carries, and that historical zero-chip incidents were resolved
with a named root cause rather than silently. Also pins the host-club fix in
fn_tournament_club_for_user: a union-hosted tournament's own club is accepted
as the preferred club without a union_clubs row, an active/approved membership
is still required, the migration proves itself against the satellite winner it
was written for, and a horse winner is owed exactly what a human is (10.5).
