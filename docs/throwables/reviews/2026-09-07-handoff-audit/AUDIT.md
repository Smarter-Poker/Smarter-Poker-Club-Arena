...
| `horseshoe`             | Rig      | Fourth material pass: 36 combined beat/rung frames and 3x detail review | Pending            |
...
| `champagne`             | Rig      | Fourth material pass: 36 combined beat/rung frames and 3x detail review | Pending            |
...
| Art upgrade for all original rigs        | Eleven revised; seven still need the new material pass. All picker artwork remains pending. Renders are dimensional SVG, not actual 3D models.                                                                                                                                                                                                                      |
...
| Publication                              | PR #3494 merged as f53c1a4763bb035f62e2a29c55a2db0d29ccec4d; all its PR workflows passed. Production read during this audit returned a9b7697172fa9cd4388329249879d7c6cb20823f, so the follow-up is not yet production verified. PR #3503 has since merged as 0ea76a50ca02d55e08aa0cec30857d4a0c95ca92. The fourth material pass needs its own CI/merge/publication. |
