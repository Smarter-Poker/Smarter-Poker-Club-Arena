...
The receipt includes source file hashes, exact revisions/image ID, fixed allowlisted service observations and cleanup booleans. Raw build/service output, session data, credentials and environment are not included. Abrupt runner termination can prevent receipt creation; missing evidence is not success.
