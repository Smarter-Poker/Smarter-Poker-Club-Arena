...
files=(Dockerfile package.json package-lock.json fixture-server.mjs runtime-files.mjs gateway.mjs auth-fixture.mjs actors.mjs financial-route-phase.mjs seed-fixture.mjs native-smoke.mjs observation-bridge.mjs)
