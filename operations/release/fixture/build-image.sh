...
files=(Dockerfile package.json package-lock.json fixture-server.mjs runtime-files.mjs gateway.mjs auth-fixture.mjs actors.mjs seed-fixture.mjs native-smoke.mjs observation-bridge.mjs)
