...
const targetStart = "    // ── Insert hand_players rows ──────────────────────────────────────────";
...
const replaceWith = `    // NOTE: hand_players insertion was removed in Phase 11. ca_hand_facts is the new authoritative source.
