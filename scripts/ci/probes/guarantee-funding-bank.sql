...
-- Exercise the bank-selection authority directly.  The public wrapper now
-- also proves the real escrow/journal rows, which this deliberately isolated
-- temp-table harness does not model.
