DO $probe$
DECLARE src text; r jsonb; private_case boolean; event uuid:='00000000-0000-4000-8000-000000000001';
...
RAISE EXCEPTION 'AUDIT_TEST_PASS: actual guarantee function uses event union, preserves private and standalone club funding, replay and missing-bank fallback; all rolled back';
END $probe$;
