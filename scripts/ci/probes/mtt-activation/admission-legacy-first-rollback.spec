...
step "a_action" { SELECT r46_activation.enter_event('a'); }
...
step "b_action" { SELECT r46_activation.activate(); }
...
step "final_state" { SELECT r46_activation.verify_final('admission_legacy_first_rollback'); }
