...
step "a_action" { SELECT r46_mtt_isolation.ensure('a','created'); }
...
step "b_action" { SELECT r46_mtt_isolation.ensure('b','existing_active'); }
...
step "final_state" { SELECT r46_mtt_isolation.verify_final('creation_commit'); }
