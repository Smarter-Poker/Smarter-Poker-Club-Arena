...
step "a_action" { SELECT r46_mtt_isolation.expect_direct_target_refusal(); }
...
step "b_action" { SELECT r46_mtt_isolation.edit_target(false); }
...
step "observed_wait" { SELECT r46_mtt_isolation.blocked('b','a'); }
step "final_state" { SELECT r46_mtt_isolation.verify_final('edit_before_creation'); }

permutation "b_begin" "b_action" "a_begin" "a_action" "observed_wait" "b_finish" "a_finish" "final_state"
