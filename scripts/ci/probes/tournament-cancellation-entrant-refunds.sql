...
-- The satellite fixture is the immutable output shape consumed by the
-- cancellation function: a funded prize-liability transfer, roster
-- provenance, target fee record and matching entitlement. This setup is
...
UPDATE public.tournaments
   SET current_players=2,prize_pool=180,total_rake=20
 WHERE id='d3000000-0000-4000-8000-000000000002';

UPDATE public.tournament_escrow
   SET gross_in=190,fee_entries_in=10,satellite_fee_in=10,
       bounty_in=0,satellite_in=0,
       prize_balance=180,bounty_balance=0,fee_balance=20,
