...
def upsert_function_block(source):
    start = source.index('CREATE OR REPLACE FUNCTION public.fn_upsert_tournament_schedule')
...
try:
    ...
    run('preimage-matches-pinned-md5', PREIMAGE_MD5,
        '1ba7d70943cf1553a07cb7dc1a13d6e9 b8dd7cc8e0996889a936affdc732b664')
    ...
    run('refusal-left-preimage-intact', PREIMAGE_MD5,
        '1ba7d70943cf1553a07cb7dc1a13d6e9 b8dd7cc8e0996889a936affdc732b664')
    ...
    # ── Apply ──
    run('apply', INSTALLER)
    run('postimage-pinned', PREIMAGE_MD5, '1362b029e14fc53524890b4f7e117181 b5ae29c619954f64648fd34c89d6625a')
