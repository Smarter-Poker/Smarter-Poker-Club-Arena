-- Read-only export 2026-09-08 of the installed function for isolated tests.
-- pg_get_functiondef MD5 ca0a0d6fe1f01c1f2bed49e7db1fd7e8; not a migration.
-- Includes later dynamic migration patches absent from the original CREATE.
