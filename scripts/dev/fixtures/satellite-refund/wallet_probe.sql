...
VALUES('c4000000-0000-4000-8000-000000000001','c3000000-0000-4000-8000-000000000001','c1000000-0000-4000-8000-000000000001','registered',false);
...
VALUES('c5000000-0000-4000-8000-000000000001','c1000000-0000-4000-8000-000000000001','player_wallet','c1000000-0000-4000-8000-000000000001','prize_liability','c3000000-0000-4000-8000-000000000001',200,'tournament_buyin','c2000000-0000-4000-8000-000000000001','c3000000-0000-4000-8000-000000000001',jsonb_build_object('user_id','c1000000-0000-4000-8000-000000000001','registration_id','c4000000-0000-4000-8000-000000000001'));
...
VALUES('c6000000-0000-4000-8000-000000000001','c3000000-0000-4000-8000-000000000001','c1000000-0000-4000-8000-000000000001','wallet_charge','tournament_buyin','c2000000-0000-4000-8000-000000000001',200,180,0,20,'c5000000-0000-4000-8000-000000000001',NULL,NULL,NULL,'wallet_gross','atomic_wallet_charge');
INSERT INTO public.rake_records(id,club_id,rake_amount,is_tournament,tournament_id,source,metadata)
VALUES('c7000000-0000-4000-8000-000000000001','c2000000-0000-4000-8000-000000000002',20,true,'c3000000-0000-4000-8000-000000000001','fn_register_for_tournament',jsonb_build_object('user_id','c1000000-0000-4000-8000-000000000001','registration_id','c4000000-0000-4000-8000-000000000001','kind','tournament_entry_fee'));
-- Fixture already represents the wallet after its original debit.
SET LOCAL session_replication_role=replica;
INSERT INTO public.wallet_transactions(user_id,wallet_type,amount,type,category,related_entity_id)
VALUES('c1000000-0000-4000-8000-000000000001','PLAYER',200,'debit','tournament_buyin','c3000000-0000-4000-8000-000000000001');
...
BEGIN
 ...
 IF expected_cash THEN
  ...
  IF NOT refused OR (SELECT chip_balance FROM public.club_members)<>300
     ...
     OR (SELECT count(*) FROM public.wallet_transactions)<>2 THEN
   RAISE EXCEPTION 'consumed entitlement was paid twice';
  END IF;
  IF (r->>'wallet_chips_from_satellite_entitlements')::numeric IS DISTINCT FROM 0 THEN
