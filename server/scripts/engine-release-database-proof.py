...
# Exact service-role READ ONLY result from retired-origin focused-2 qualification,
# migration 20260919024642; original mixed authority plus the retired-owner boundary.
...
MIXED_CUSTODY_CONTRACT = {'kind': 'f06_mixed_custody_contract_v1',
 'functions': [{'acl': '{postgres=X/postgres,service_role=X/postgres}',
               ...
               {'acl': '{postgres=X/postgres,service_role=X/postgres}',
                'owner': 'postgres',
                'config': ['search_path=pg_catalog, public, smarter_private'],
                'body_md5': 'af89bc29c2d839e950f678fedad1ad75',
                'signature': 'public.fn_f06_prepare_mixed_manager_custody(uuid,uuid,uuid,uuid,jsonb,jsonb)',
                'volatility': 'v',
                'definition_md5': '626b7f8687e5747fde18629c1ccbba29',
                'security_definer': True},
               ...
               {'acl': '{postgres=X/postgres}',
                'owner': 'postgres',
                'config': ['search_path=pg_catalog, public, smarter_private'],
                'body_md5': '5e64168fd92de18b7794f8d5ccb7cabf',
                'signature': 'smarter_private.f06_retired_origin_snapshot(jsonb)',
                'volatility': 'v',
                'definition_md5': 'd677bf2f98d317a013ca7e289f962b5a',
                'security_definer': True},
               {'acl': '{postgres=X/postgres}',
                'owner': 'postgres',
                'config': ['search_path=pg_catalog, public, smarter_private'],
