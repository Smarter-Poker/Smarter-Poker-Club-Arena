 ...
 *
 * Ported from client: src/engine/OFCPineappleEngine.ts (691 lines)
 * Server adaptation: PURE LOGIC — no masterBus in original, no changes needed.
 *   Object literal export preserved. Uses crypto.randomUUID() (Node.js native).
 */
