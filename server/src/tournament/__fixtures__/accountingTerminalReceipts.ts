...
export const accountingTerminalReceipts = [
  {
    ...
    fully_settled: true,
    table_closure: {
      source_seat_ids: ['00000000-0000-0000-0000-000000005071'],
      closed_table_ids: ['00000000-0000-0000-0000-000000005070'],
      released_seat_ids: ['00000000-0000-0000-0000-000000005071'],
      source_seat_count: 1,
  ...
  },
  {
    ...
    fully_settled: true,
    table_closure: {
      source_seat_ids: ['00000000-0000-0000-0000-000000005171'],
      closed_table_ids: ['00000000-0000-0000-0000-000000005170'],
      released_seat_ids: ['00000000-0000-0000-0000-000000005171'],
      source_seat_count: 1,
      closed_table_count: 1,
      released_seat_count: 1,
    },
...
export const fullLifecycleTerminalReceipts = [
  {
    ...
    fully_settled: true,
    table_closure: {
      source_seat_ids: ['d6000000-0000-4000-8000-000000000002'],
      closed_table_ids: ['d5000000-0000-4000-8000-000000000002'],
      released_seat_ids: ['d6000000-0000-4000-8000-000000000002'],
      source_seat_count: 1,
      closed_table_count: 1,
      released_seat_count: 1,
    },
