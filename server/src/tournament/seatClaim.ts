 ...
 * the player's seats does not get to add one — the sweeps run every five
 * seconds, so refusing costs a player one cycle, while guessing costs the
 * tournament its chip count.
 */
