...
Promo Wallet, Retains Categorized Retry History, Links Every Receipt To Its
Immutable Batch, And Splits Occupied Prize Places Across Tied Players With
Exact-Cent Conservation. An Authenticated Read-Only Status Model Powers The
Club Arena Settlement Desk Without Granting Browser Payout Authority. The
Production-Safe Verification Harness Moves No Chips. This Work Does Not Change
A Bible V8 Table-Game Compliance Row.
...
>
> Dan, verbatim: _"Time banks grant 20 seconds extra time, can only 2 per street
> can be used, never more"_ and _"every player base time is 15 seconds... time
> extension is 20 seconds (time bank 20 seconds added)"_.
>
