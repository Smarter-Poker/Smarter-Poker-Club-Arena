...
export function SettlementCronStatus() {
  return (
    <div style={{ padding: '12px 16px', borderRadius: 8, border: '1px solid #667085',
      fontSize: 13, color: '#e4e7ec' }}>
      <strong>Weekly Accounting</strong>
      <p style={{ margin: '6px 0' }}>Open A Club Or Union To View Its Recorded Accounting Status.</p>
