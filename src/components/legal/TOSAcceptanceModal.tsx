...
export default function TOSAcceptanceModal({ onAccept }: TOSAcceptanceModalProps) {
  ...
  /* ONE CONSOLE (#ClubArenaConsole): the spade master. The terms print in
     a scroll well on the black glass between the rails; the agreement row,
     the server's reason and ACCEPT & CONTINUE as a lit word sit under an
     engraved rule. A blocking gate has one action and no way out, so the
     foot is the flat cap. Nothing is drawn. */
  return (
    <div className="tos-modal-overlay">
      ...
      >
        <SpadeConsole
          ...
          pill={hasScrolledToBottom ? 'Ready' : 'Read First'}
          pillInk={hasScrolledToBottom ? 'green' : 'muted'}
          foot="foot"
          className="tosc__console"
        >
          <div className="tosc__terms" onScroll={handleScroll}>
            ...
            <p>
              ...
              Assigns Them No Monetary Value; Any Arrangement Between A Member And Their Club's
              Agent Is Private And Off-Platform. Diamonds Are A Virtual Currency Sold By
              Smarter.Poker For Use Inside The Platform Only.
            </p>
            ...
            <p>
              All Content, Features, And Functionality Of The Service Are Owned By Club Arena And
            ...
            <div className="tosc__scroll-hint sc-ink--blue">
          ...
          <div className="tosc__agree">
            ...
            {error && (
              <p className="tosc__error sc-ink--red" role="alert">
                {error}
              </p>
            )}
            ...
            <button
              type="button"
              className="tosc-word sc-ink--white"
