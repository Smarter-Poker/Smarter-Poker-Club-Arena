        ...
        <div className="rules-modal__header">
          <div className="rules-modal__title-row">
            ...
            <div className="rules-modal__title-group">
              <h2 className="rules-modal__title">{variant} Rules</h2>
              <span className="rules-modal__subtitle">{stakes}</span>
            </div>
          </div>
                ...
                {isPLO ? (
                  <>
                    ...
                    <li>
                      ...
                      <strong>Five Community Cards</strong> Are Dealt - A "Flop" Of Three, "Turn" Of
              ...
              {isPotLimit ? (
                <>
                  ...
                  <p className="rules-modal__text">
                    ...
                    Act After The Blinds Are Posted Has Three Options: Fold, Call, Or Raise, Up To A
                    Maximum Of The "Pot."
                  </p>
                  ...
                  <p className="rules-modal__text">
                    When Players Do Not Have Enough Chips To Match A Full Bet, They May Call For The
                    Amount They Have Left (Are All-In) And Any Amount Over That Is Put Into A "Side
                    Pot" That Is Played For Only By Players Who Can Match The Bet.
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p className="rules-modal__text">
                    ...
                    Player Does Not Have Enough Chips To Match An Opponent's Bet, They Can Call With
                    Their Remaining Chips To Create A "Side Pot" For The Remaining Active Players.
                  </p>
                </>
              )}
            </div>
