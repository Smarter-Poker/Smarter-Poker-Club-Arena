 ...
 *
 *  2. LOCATION. Next.js moves between pages with pushState, which no parent
 ...
 *
 *  3. CLUB ARENA. A link inside the hub back to /hub/club-arena/... must NOT
 ...
 * the player is already on, every 250ms.
 */

import { useEffect, useRef, type RefObject } from 'react';
import { HUB_FRAME_POLL_MS, clubArenaPathFromHubUrl } from '../../utils/hubTab';
