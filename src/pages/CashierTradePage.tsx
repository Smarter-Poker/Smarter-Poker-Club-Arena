  ...
  return (
    <div className={styles.page} data-cashier-surface="trade">
      <CashierConsoleSurface
        ...
        title="Cashier"
        subtitle={`Every Chip Accounted For · ${currentClubLabel}`}
        ...
        >
          ...
          >
            ...
            >
              ...
              {amountModal === 'send' && (
                <div className={styles.modalHint}>
                  You Can Claim These Chips Back For Ten Minutes. After That The Player Must Request
                  A Cash Out.
                </div>
              )}
