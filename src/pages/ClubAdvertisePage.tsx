      ...
      <section className="club-advertise__card">
        ...
        {rate ? (
          <p className="club-advertise__hint">
            Exactly {rate.creativeWidth} x {rate.creativeHeight} Pixels, WebP, PNG Or JPEG, Under{' '}
            {Math.round(rate.maxBytes / 1024)} KB. It Scales With The Page And Is Never Cropped.
          </p>
        ) : null}
        <div
