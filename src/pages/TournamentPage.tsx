    ...
    <div className="tournament-page">
      ...
      {selectedTournament ? (
        ...
        >
          ...
          <div className="tourn-rows">
            {asRows(selectedTournament.payout_structure)
              .slice(0, 5)
              .map((payout: any, i: number) => {
                ...
                return (
                  <div key={i} className="tourn-row tourn-row--triple">
                    ...
                    <span className="tourn-value sc-ink--muted">
                      {Math.round(Number(payout.percentage) || 0)}%
                    </span>
                    ...
                    <span className="tourn-value sc-ink--silver">
                      {compactChips(
                        Math.round(
                          (Number(selectedTournament.prize_pool) || 0) *
                            ((Number(payout.percentage) || 0) / 100)
                        )
                      )}
                    </span>
                  </div>
                ...
                {asRows(selectedTournament.payout_structure)
                  ...
                  .map((p: any, i: number) => (
                    <div key={i} className="tourn-row">
                      <span className="sc-label sc-ink--blue">{ordinal(i + 1)}</span>
                      <span className="tourn-value sc-ink--gold">
                        {compactChips(
                          Math.round(
                            (Number(selectedTournament.prize_pool) || 0) *
                              ((Number(p.percentage) || 0) / 100)
                          )
                        )}
                      </span>
                    </div>
