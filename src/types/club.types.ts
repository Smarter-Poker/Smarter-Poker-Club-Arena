...
export const VARIANT_CONFIGS: Record<GameVariant, VariantConfig> = {
  nlh: {
    variant: 'nlh', display_name: 'No-Limit Hold\'em', hole_cards: 2,
    mandatory_hole_card_usage: 'any', board_cards_total: 5,
    board_reveal_pattern: [3, 1, 1], discard_phase_enabled: false,
    discard_after_street: null, discard_count: 0,
    hi_lo_enabled: false, hi_lo_qualifier: null,
    short_deck: false, short_deck_min_rank: null,
    betting_structure: 'no_limit', min_players: 2, max_players: 9,
  },
  plo4: {
    variant: 'plo4', display_name: 'Pot-Limit Omaha', hole_cards: 4,
    mandatory_hole_card_usage: 'exactly_2', board_cards_total: 5,
    board_reveal_pattern: [3, 1, 1], discard_phase_enabled: false,
    discard_after_street: null, discard_count: 0,
    hi_lo_enabled: false, hi_lo_qualifier: null,
    short_deck: false, short_deck_min_rank: null,
    betting_structure: 'pot_limit', min_players: 2, max_players: 9,
  },
  plo5: {
    variant: 'plo5', display_name: 'PLO-5 Card', hole_cards: 5,
    mandatory_hole_card_usage: 'exactly_2', board_cards_total: 5,
    board_reveal_pattern: [3, 1, 1], discard_phase_enabled: false,
    discard_after_street: null, discard_count: 0,
    hi_lo_enabled: false, hi_lo_qualifier: null,
    short_deck: false, short_deck_min_rank: null,
    betting_structure: 'pot_limit', min_players: 2, max_players: 6,
  },
  plo6: {
    variant: 'plo6', display_name: 'PLO-6 Card', hole_cards: 6,
    mandatory_hole_card_usage: 'exactly_2', board_cards_total: 5,
    board_reveal_pattern: [3, 1, 1], discard_phase_enabled: false,
    discard_after_street: null, discard_count: 0,
    hi_lo_enabled: false, hi_lo_qualifier: null,
  ...
  plo8: {
    variant: 'plo8', display_name: 'Omaha Hi-Lo', hole_cards: 4,
    mandatory_hole_card_usage: 'exactly_2', board_cards_total: 5,
    board_reveal_pattern: [3, 1, 1], discard_phase_enabled: false,
    discard_after_street: null, discard_count: 0,
    hi_lo_enabled: true, hi_lo_qualifier: 8,
    short_deck: false, short_deck_min_rank: null,
    betting_structure: 'pot_limit', min_players: 2, max_players: 9,
  },
  pineapple: {
    variant: 'pineapple', display_name: 'Crazy Pineapple', hole_cards: 3,
    mandatory_hole_card_usage: 'any', board_cards_total: 5,
    board_reveal_pattern: [3, 1, 1], discard_phase_enabled: true,
    discard_after_street: 'flop', discard_count: 1,
    hi_lo_enabled: false, hi_lo_qualifier: null,
    short_deck: false, short_deck_min_rank: null,
    betting_structure: 'no_limit', min_players: 2, max_players: 9,
  },
  short_deck: {
    variant: 'short_deck', display_name: 'Short Deck (6+)', hole_cards: 2,
    mandatory_hole_card_usage: 'any', board_cards_total: 5,
    board_reveal_pattern: [3, 1, 1], discard_phase_enabled: false,
    discard_after_street: null, discard_count: 0,
    hi_lo_enabled: false, hi_lo_qualifier: null,
    short_deck: true, short_deck_min_rank: '6',
    betting_structure: 'no_limit', min_players: 2, max_players: 9,
  },
};
...
export interface RecoveryState {
  ...
  recovery_status: 'synced' | 'desync_detected' | 'resync_in_progress' | 'resync_complete' | 'resync_failed';
}
