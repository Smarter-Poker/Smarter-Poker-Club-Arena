...
BEGIN
  ...
  FOR required IN SELECT * FROM (VALUES
    ...
    ('public.fn_ca_settlement_lane_doctrine()','d6885832ceaa6c071d40bdc26a0b16fa'),
...
BEGIN
 ...
 IF md5(source)<>'d6885832ceaa6c071d40bdc26a0b16fa' THEN RAISE EXCEPTION 'mixed initial lane doctrine preimage differs' USING ERRCODE='55000'; END IF;
 ...
 IF md5(source)<>'e17791cf6d8911677695de28e681d1df' THEN RAISE EXCEPTION 'mixed initial lane doctrine patch differs' USING ERRCODE='55000'; END IF;
 EXECUTE source;
 IF md5(pg_get_functiondef('public.fn_ca_settlement_lane_doctrine()'::regprocedure))<>'e17791cf6d8911677695de28e681d1df' THEN RAISE EXCEPTION 'mixed initial lane doctrine postimage differs' USING ERRCODE='55000'; END IF;
END $doctrine$;
COMMIT;
