...
-- Applied to production 20260825192706; the .sql file was never committed at the
...
BEGIN
  ...
  -- inventory already built from them, and changing one would make the record
  -- of how the money was split a lie.
