...
-- Applied to production 20260825193256; the .sql file was never committed at the
-- time (see docs/changelog and issue: unrecorded-migration backfill). Content is
-- byte-exact to what ran. Do NOT re-apply; it is already live.

-- diamonds_remaining was serialising as TEXT ("42") because ->> yields text,
-- while the API type promises a number. ::numeric makes the wire format match.
