...
-- horses by h->>'sum_net_bb' — a TEXT sort, so -100 sorted before -99 and
-- the "worst horses first" list was lexicographic nonsense at the exact
-- boundaries the panel exists to surface. Cast to numeric.
-- ═══════════════════════════════════════════════════════════════════════════
