...
-- Applied to production 20260826170946; the .sql file was never committed at the
-- time (see docs/changelog and issue: unrecorded-migration backfill). Content is
-- byte-exact to what ran. Do NOT re-apply; it is already live.

-- V16 DEEP READS (2026-08-26). Repo file: supabase/migrations/20260826170922_deep_read_stats.sql
