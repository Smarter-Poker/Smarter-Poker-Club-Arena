...
-- Applied to production 20260826175031; the .sql file was never committed at the
-- time (see docs/changelog and issue: unrecorded-migration backfill). Content is
-- byte-exact to what ran. Do NOT re-apply; it is already live.

-- BRAIN TELEMETRY part 2: fn_run_horse_daily_audit v2 with layer-silence
-- findings + telemetry/all-hands stats. Repo: 20260826174902_brain_telemetry.sql
