-- ═══════════════════════════════════════════════════════════════════════════
-- SATELLITE QUALIFIER BADGE
-- Adds a boolean to tournament_players so the UI can flag players who won
-- their seat via a satellite. Updates fn_award_satellite_seat to set it.
-- ═══════════════════════════════════════════════════════════════════════════
