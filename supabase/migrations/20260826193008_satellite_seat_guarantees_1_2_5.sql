...
-- Applied to production 20260826193008; the .sql file was never committed at the
...
--
--   $5  -> 1 seat   funded by 40 of 200 entries    (200 chips of 1,000 max)
--   $10 -> 2 seats  funded by 40 of 100 entries    (400 chips of 1,000 max)
--   $25 -> 5 seats  funded by 40 of 40 entries     <-- see below
--
...
-- field was deliberate.
--
-- WHAT IS DELIBERATELY NOT TOUCHED: any satellite instance that is already
-- RUNNING or that has players registered against it. Those advertised five
-- seats and people entered on that basis; reducing a guarantee under someone
-- who already paid is changing the deal after the fact. They run out at the
-- number they promised. Only pre-start instances with an empty field are
-- rewritten, plus the schedules, so every future spawn is correct.
...
-- ── 2. THE INSTANCES ALREADY ON THE BOARD, BUT ONLY THE EMPTY PRE-START ONES ─
