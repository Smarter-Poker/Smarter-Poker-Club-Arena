-- ═══════════════════════════════════════════════════════════════════════════
-- LAYER WATCH v2 (2026-08-26): the proof-of-receipt list grows with the
-- brain. V17 (positional pressure, river probes, call-side blockers, short
-- deck) and V18 (straddle fix, squeeze response, self-image, exploit sizing)
-- join the layer_silent watch as warn-level entries — every deployed layer
-- is watched from the day it ships.
-- ═══════════════════════════════════════════════════════════════════════════
