...
-- Applied to production 20260827010950; the .sql file was never committed at the
-- time (see docs/changelog and issue: unrecorded-migration backfill). Content is
-- byte-exact to what ran. Do NOT re-apply; it is already live.

-- INSURANCE P&L IN THE DAILY REPORTS — Dan 2026-08-26. Source of truth is
-- insurance_transactions (one row per settled contract; bank_type says whose
-- bank moved). ca_club_revenue gains totals.insurance + per-day ins_net with
-- honest bank attribution; ca_union_insurance_pnl is the union's live daily
-- insurance P&L (totals, per-day, per-club), oversight-gated.
