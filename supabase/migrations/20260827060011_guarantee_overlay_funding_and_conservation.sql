...
-- Applied to production 20260827060011; the .sql file was never committed at the
-- time (see docs/changelog and issue: unrecorded-migration backfill). Content is
-- byte-exact to what ran. Do NOT re-apply; it is already live.

-- GUARANTEE OVERLAY FUNDING + TOURNAMENT MONEY CONSERVATION (2026-08-27, phase 3)
-- Dan approved 2026-08-27: (1) back-pay all underpaid HU winners; (2) overlays
-- funded from the host club treasury.
-- Full rationale in repo: supabase/migrations/20260827_guarantee_overlay_funding_and_conservation.sql
