...
-- Applied to production 20260827170638; the .sql file was never committed at the
...
--                 cards simply were not stored, and the showdown block cannot
--                 draw face-down cards against the right seats.
...
--
--  Nothing is removed and no key changes shape, so the existing client keeps
--  working; the new keys are additive.
-- ============================================================================
