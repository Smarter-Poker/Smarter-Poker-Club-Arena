...
-- Applied to production 20260828083039; the .sql file was never committed at the
-- time (see docs/changelog and issue: unrecorded-migration backfill). Content is
-- byte-exact to what ran. Do NOT re-apply; it is already live.

-- INSURANCE: nightly reconciliation + observability views - 2026-08-28
-- Mirrored in repo: supabase/migrations/20260828120500_insurance_reconciliation_and_views.sql
...
BEGIN
  ...
  -- INSURANCE + EV-CASHOUT BANK (added 2026-08-28)
  WITH led AS (
