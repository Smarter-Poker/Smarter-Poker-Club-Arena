...
-- Applied to production 20260828164919; the .sql file was never committed at the
-- time (see docs/changelog and issue: unrecorded-migration backfill). Content is
-- byte-exact to what ran. Do NOT re-apply; it is already live.

-- 2026-08-28: reconcile_ledger_nightly gains the insurance_offer_unresolved
-- section (uses fn_unresolved_insurance_offers). Full-body replace; identical
-- to the previous version plus the one new INSERT after insurance_bank.
