...
--
-- This migration WAS applied to production at 20260830090000, but its SQL was not
...
-- name is the clue: "personal_assistant_phase_three_atomic_state") against a nearby dated backup, or the PR that
-- carried it. Do NOT invent SQL here and do NOT re-run anything.
SELECT 'applied 20260830090000: personal_assistant_phase_three_atomic_state (statements not preserved)' AS unrecoverable_backfill_note;
