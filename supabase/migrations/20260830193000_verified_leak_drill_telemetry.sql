...
--
-- This migration WAS applied to production at 20260830193000, but its SQL was not
...
-- name is the clue: "verified_leak_drill_telemetry") against a nearby dated backup, or the PR that
-- carried it. Do NOT invent SQL here and do NOT re-run anything.
SELECT 'applied 20260830193000: verified_leak_drill_telemetry (statements not preserved)' AS unrecoverable_backfill_note;
