...
--
-- This migration WAS applied to production at 20260830210000, but its SQL was not
...
-- name is the clue: "pnm_phase10_directory_operations") against a nearby dated backup, or the PR that
-- carried it. Do NOT invent SQL here and do NOT re-run anything.
SELECT 'applied 20260830210000: pnm_phase10_directory_operations (statements not preserved)' AS unrecoverable_backfill_note;
