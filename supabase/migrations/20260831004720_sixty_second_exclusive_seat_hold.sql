...
-- Applied to production 20260831004720; the .sql file was never committed at the
-- time (see docs/changelog and issue: unrecorded-migration backfill). Content is
-- byte-exact to what ran. Do NOT re-apply; it is already live.

-- SIXTY-SECOND EXCLUSIVE SEAT HOLD (Dan 2026-08-30). Full commentary in repo
-- file supabase/migrations/20260831010000_sixty_second_exclusive_seat_hold.sql
