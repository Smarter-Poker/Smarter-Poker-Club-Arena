...
--
-- This migration WAS applied to production at 20260831093000, but its SQL was not
...
-- name is the clue: "lock_leak_hand_examples_to_owner") against a nearby dated backup, or the PR that
-- carried it. Do NOT invent SQL here and do NOT re-run anything.
SELECT 'applied 20260831093000: lock_leak_hand_examples_to_owner (statements not preserved)' AS unrecoverable_backfill_note;
