...
--
-- This migration WAS applied to production at 20260831095000, but its SQL was not
...
-- name is the clue: "strict_personal_assistant_rate_limit") against a nearby dated backup, or the PR that
-- carried it. Do NOT invent SQL here and do NOT re-run anything.
SELECT 'applied 20260831095000: strict_personal_assistant_rate_limit (statements not preserved)' AS unrecoverable_backfill_note;
