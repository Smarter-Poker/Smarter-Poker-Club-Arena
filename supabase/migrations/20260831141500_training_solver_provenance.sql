...
--
-- This migration WAS applied to production at 20260831141500, but its SQL was not
...
-- name is the clue: "training_solver_provenance") against a nearby dated backup, or the PR that
-- carried it. Do NOT invent SQL here and do NOT re-run anything.
SELECT 'applied 20260831141500: training_solver_provenance (statements not preserved)' AS unrecoverable_backfill_note;
