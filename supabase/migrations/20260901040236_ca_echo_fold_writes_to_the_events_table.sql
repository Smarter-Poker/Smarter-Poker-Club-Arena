-- Correction to ca_resolved_echoes_fold_instead_of_repaging, caught before
-- any echo fired: incident events live in ca_incident_events, not in a
-- jsonb column on ca_drift_incidents. The fold now writes there.
