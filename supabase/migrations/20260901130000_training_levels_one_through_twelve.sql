...
--
-- This migration WAS applied to production at 20260901130000, but its SQL was not
...
-- name is the clue: "training_levels_one_through_twelve") against a nearby dated backup, or the PR that
-- carried it. Do NOT invent SQL here and do NOT re-run anything.
SELECT 'applied 20260901130000: training_levels_one_through_twelve (statements not preserved)' AS unrecoverable_backfill_note;
