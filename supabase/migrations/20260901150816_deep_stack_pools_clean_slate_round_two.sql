...
-- Applied to production via Supabase MCP 2026-09-01 15:08 UTC.
-- Round one DID reset bbj_pools and the spin pool -- then the 15:00:03 UTC
-- engine settlement sweep drained the backlog of PRE-FREEZE spins onto the
-- fresh slate, and round one had missed club_wallets entirely (the sidebar's
-- "Rake Treasury"). Verified before this run: 0 unsettled spins, 0 fresh
-- settlements -- the backlog was spent, so this reset sticks.
-- =============================================================================
DO $$
DECLARE
