...
--
-- which is the shape caught on 2026-08-31, and it has refused 523 attempts
-- since. But the block is keyed on what the CALLER named the credit, not on
-- what the credit does. Anything arriving with a different category -
...
-- definition. Dan ruled on 2026-09-01 to leave it as history rather than
-- reverse 410 wallets; it is documented in incident
-- audit:tournament-stack-cashouts:2026-08 so nobody rediscovers it as a fresh
-- mystery. This migration only makes sure it cannot happen again.
