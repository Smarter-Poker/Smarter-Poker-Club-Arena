-- Wires completed_without_a_champion and prize_overpay_unexplained_10d into
-- fn_ca_ratchet_watch. Six ratchets now. A rise in either raises a CRITICAL:
-- a settlement that cannot name a winner is stuck, and a settlement that pays
-- beyond every funding source is money leaving the club with nothing behind it.
--
-- This file carries the final body of fn_ca_ratchet_watch for the Phase 3
-- batch; 20260901231551 then narrows only fn_ca_prize_overpay_count's window.
