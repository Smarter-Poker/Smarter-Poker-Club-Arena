...
-- Applied to production 20260902051122; the .sql file was never committed at the
-- time (chip-std phase 1.5 mirror, docs/changelog/2026-09-02-chip-std-p1-mirror.md).
-- Content is byte-exact to what ran. Do NOT re-apply; it is already live.

-- chip_ledger.performed_by is NOT NULL and I omitted it; refused, rolled back,
-- nothing written. Third schema constraint tonight to catch a money migration
-- before it did anything, which is the system working exactly as intended.
--
-- The actor is resolved from the live overlay path's own rows rather than
-- hardcoded, so a bank-funded back-payment is attributed to the same operator
-- as a bank-funded overlay and the two cannot drift apart.
