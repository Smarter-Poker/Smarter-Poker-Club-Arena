...
-- Applied to production 20260903031147; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260903031147   (the stamp IS the apply time, UTC: 2026-09-03 03:11:47)
--   name        player_search_no_count_and_own_seat
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 20066 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260903031147 IS ALREADY IN
...
--     FUNCTION       public.fn_search_players
--
