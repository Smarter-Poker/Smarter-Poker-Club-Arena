...
-- Applied to production 20260905085527; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260905085527   (the stamp IS the apply time, UTC: 2026-09-05 08:55:27)
--   name        a_guard_resolves_its_own_tables
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 4912 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260905085527 IS ALREADY IN
