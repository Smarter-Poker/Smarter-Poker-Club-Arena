...
-- Applied to production 20260906021005; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260906021005   (the stamp IS the apply time, UTC: 2026-09-06 02:10:05)
--   name        leaderboard_settlement_follows_published_period
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 5350 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260906021005 IS ALREADY IN
...
--     FUNCTION       public.fn_settle_due_leaderboards
--
