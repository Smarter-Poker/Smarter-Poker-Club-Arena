...
DO $guard$
BEGIN
  IF md5(pg_get_functiondef('public.fn_apply_prize_guarantee(uuid,text)'::regprocedure)) <> '783003f37846d803c2f358bbd3cacf8a' THEN
    RAISE EXCEPTION 'Guarantee function changed since audited baseline';
  END IF;
END $guard$;
