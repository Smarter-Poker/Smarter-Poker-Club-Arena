...
-- Applied to production 20260907233813; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260907233813   (the stamp IS the apply time, UTC: 2026-09-07 23:38:13)
--   name        the_bridge_rate_is_a_row_and_the_ledger_learns_the_wheel
--   created_by  (not recorded)
--   statements  1 statement(s), 21020 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260907233813 IS ALREADY IN
...
--     TRIGGER        trg_ca_bridge_rate_history
--     FUNCTION       public.fn_ca_bridge_rate_history, public.fn_ca_bridge_rate, public.fn_mint_chips_from_diamonds, public.fn_ca_diamond_engine_of
--     TABLE          public.ca_bridge_rate, public.ca_bridge_rate_history
--     POLICY         ca_bridge_rate_read
--     CONSTRAINT     ca_payout_freeze_scope_check on public.ca_payout_freeze
--     DROP           TRIGGER trg_ca_bridge_rate_history, POLICY ca_bridge_rate_read
--     RLS-ENABLE     
--
