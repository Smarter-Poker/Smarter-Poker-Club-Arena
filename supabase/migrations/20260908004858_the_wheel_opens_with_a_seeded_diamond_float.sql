...
-- Applied to production 20260908004858; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260908004858   (the stamp IS the apply time, UTC: 2026-09-08 00:48:58)
--   name        the_wheel_opens_with_a_seeded_diamond_float
--   created_by  (not recorded)
--   statements  1 statement(s), 17355 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260908004858 IS ALREADY IN
...
--     TRIGGER        trg_wheel_pool_seed
--     FUNCTION       public.fn_wheel_pool_seed, public.fn_wheel_set_config, public.fn_wheel_metrics
--     DROP           TRIGGER trg_wheel_pool_seed
--
