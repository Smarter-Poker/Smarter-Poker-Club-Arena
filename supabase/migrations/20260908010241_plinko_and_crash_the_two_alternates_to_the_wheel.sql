...
-- Applied to production 20260908010241; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260908010241   (the stamp IS the apply time, UTC: 2026-09-08 01:02:41)
--   name        plinko_and_crash_the_two_alternates_to_the_wheel
--   created_by  (not recorded)
--   statements  1 statement(s), 85191 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260908010241 IS ALREADY IN
...
--     TRIGGER        trg_plinko_drops_append_only, trg_crash_rounds_append_only, trg_diamond_game_config_history_append_only, trg_diamond_game_config_history
--     FUNCTION       public.fn_diamond_game_append_only, public.fn_diamond_game_config_history, public.fn_plinko_table_audit, public.fn_plinko_activate_table, public.fn_diamond_game_commit, public.fn_diamond_game_cap_cents, public.fn_crash_point_cents, public.fn_crash_multiplier_cents
--     TABLE          public.diamond_game_configs, public.diamond_game_config_history, public.diamond_game_pools, public.diamond_game_commits, public.plinko_tables, public.plinko_drops, public.crash_rounds
--     INDEX          diamond_game_commits_user_open_idx, plinko_drops_user_time_idx, plinko_drops_host_time_idx, crash_rounds_user_time_idx, crash_rounds_host_time_idx, crash_rounds_open_idx
--     CONSTRAINT     ca_payout_freeze_scope_check on public.ca_payout_freeze
--     DROP           TRIGGER trg_plinko_drops_append_only, TRIGGER trg_crash_rounds_append_only, TRIGGER trg_diamond_game_config_history_append_only, TRIGGER trg_diamond_game_config_history
--     RLS-ENABLE     
--
