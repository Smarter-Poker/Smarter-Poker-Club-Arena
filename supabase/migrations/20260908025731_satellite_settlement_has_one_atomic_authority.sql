-- 20260908025731_satellite_settlement_has_one_atomic_authority.sql
--
...
-- array records which of the four production cutover events existed at that
...
CREATE TABLE public.tournament_satellite_settlement_cutover (
  ...
  migration_version      text NOT NULL
                              CHECK (migration_version = '20260908025731'),
...
BEGIN
  ...
  VALUES
    (v_tournament_id, 'satellite_remainder', 2, v_bubble.user_id,
     85.00, 0, 'migration.20260908025731.b066', NULL)
  ...
  IF NOT EXISTS (SELECT 1 FROM public.tournament_rake_settlements r
    ...
    v_rake_result := public.fn_settle_tournament_rake(
      v_tournament_id, 'migration.20260908025731.b066');
...
BEGIN
  ...
  IF (SELECT count(*)
       ...
       WHERE c.authority = 'fn_settle_satellite_tournament:v2'
         AND c.migration_version = '20260908025731'
