-- 20260908065250_tournament_cancellation_commits_one_stored_receipt
--
...
DECLARE
  ...
  c_note constant text :=
    '20260908065250: atomic cancellation receipt authority';
  v_note text;
BEGIN
...
BEGIN
  IF (SELECT count(*)
       ...
       WHERE s.source = 'atomic_cancel_tournament'
         AND s.note = '20260908065250: atomic cancellation receipt authority') <> 1 THEN
    RAISE EXCEPTION
