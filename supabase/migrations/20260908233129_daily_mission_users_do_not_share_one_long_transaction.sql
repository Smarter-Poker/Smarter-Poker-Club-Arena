...
-- Applied to production 20260908233129; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260908233129   (the stamp IS the apply time, UTC: 2026-09-08 23:31:29)
--   name        daily_mission_users_do_not_share_one_long_transaction
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 15085 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260908233129 IS ALREADY IN
...
--     FUNCTION       public.fn_drain_daily_challenge_event_outbox_user, public.fn_drain_daily_challenge_event_outbox
--     PROCEDURE      public.sp_drain_daily_challenge_event_outbox
--
