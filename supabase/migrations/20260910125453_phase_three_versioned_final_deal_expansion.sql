...
-- Applied to production 20260910125453; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260910125453   (the stamp IS the apply time, UTC: 2026-09-10 12:54:53)
--   name        phase_three_versioned_final_deal_expansion
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 45658 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260910125453 IS ALREADY IN
...
--     TRIGGER        tournament_deal_proposal_is_immutable, tournament_deal_consent_is_immutable, tournament_deal_execution_is_immutable
--     FUNCTION       public.fn_tournament_deal_proposal_is_immutable, public.fn_ca_tournament_deal_snapshot, public.fn_ca_tournament_deal_proposals_active, public.fn_get_tournament_deal_proposal, public.fn_cast_tournament_deal_vote, public.fn_get_tournament_deal_consensus, public.fn_require_exact_final_deal_proposal, public.fn_complete_tournament_terminal_proposal
--     TABLE          public.tournament_deal_proposals, public.tournament_deal_proposal_consents, public.tournament_deal_proposal_executions, public.tournament_deal_review_policy, public.tournament_deal_reviews
--     INDEX          tournament_deal_one_active_review
--     RLS-ENABLE     
--
