...
-- Applied to production 20260910183806; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260910183806   (the stamp IS the apply time, UTC: 2026-09-10 18:38:06)
--   name        the_floor_remembers_the_week
--   created_by  (not recorded)
--   statements  1 statement(s), 6309 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260910183806 IS ALREADY IN
