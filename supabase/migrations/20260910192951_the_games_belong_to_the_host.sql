...
-- Applied to production 20260910192951; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260910192951   (the stamp IS the apply time, UTC: 2026-09-10 19:29:51)
--   name        the_games_belong_to_the_host
--   created_by  (not recorded)
--   statements  1 statement(s), 105252 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260910192951 IS ALREADY IN
...
--     FUNCTION       public.fn_diamond_game_owner, public.fn_diamond_game_promo_lock, public.fn_diamond_game_promo, public.fn_diamond_game_pay_diamonds, public.fn_diamond_game_cap_cents, public.fn_diamond_game_prize_leg, public.fn_diamond_game_take_bet, public.fn_diamond_game_admit
--     DROP           FUNCTION public.fn_diamond_game_take_bet, FUNCTION public.fn_diamond_game_admit, FUNCTION pg_temp.hh_patch, FUNCTION public.fn_diamond_game_mint_leg
--
