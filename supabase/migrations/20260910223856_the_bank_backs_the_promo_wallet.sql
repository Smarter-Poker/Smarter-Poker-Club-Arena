...
-- Applied to production 20260910223856; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260910223856   (the stamp IS the apply time, UTC: 2026-09-10 22:38:56)
--   name        the_bank_backs_the_promo_wallet
--   created_by  (not recorded)
--   statements  1 statement(s), 93916 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260910223856 IS ALREADY IN
...
--     FUNCTION       public.fn_diamond_game_bank, public.fn_diamond_game_cover, public.fn_diamond_game_cover_lock, public.fn_diamond_game_pay_chips, public.fn_diamond_game_prize_leg, public.fn_diamond_game_admit, public.fn_wheel_spin_core, public.fn_wheel_spin
--     INDEX          wheel_spins_one_welcome_per_member
--     DROP           FUNCTION public.fn_diamond_game_admit, FUNCTION pg_temp.bb_patch
--
