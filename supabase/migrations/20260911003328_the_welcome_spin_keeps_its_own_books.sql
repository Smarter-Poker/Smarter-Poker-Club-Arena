...
-- Applied to production 20260911003328; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260911003328   (the stamp IS the apply time, UTC: 2026-09-11 00:33:28)
--   name        the_welcome_spin_keeps_its_own_books
--   created_by  (not recorded)
--   statements  1 statement(s), 34873 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260911003328 IS ALREADY IN
...
--     FUNCTION       public.fn_wheel_spin_result, public.fn_wheel_spin_core, public.fn_wheel_metrics
--
