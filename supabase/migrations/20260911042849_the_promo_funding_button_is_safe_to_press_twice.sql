...
-- Applied to production 20260911042849; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260911042849   (the stamp IS the apply time, UTC: 2026-09-11 04:28:49)
--   name        the_promo_funding_button_is_safe_to_press_twice
--   created_by  (not recorded)
--   statements  1 statement(s), 10481 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260911042849 IS ALREADY IN
...
--     FUNCTION       public.fn_diamond_game_fund_promo
--     DROP           FUNCTION public.fn_diamond_game_fund_promo
--
