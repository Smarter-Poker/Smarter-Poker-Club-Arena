...
-- Applied to production 20260911151934; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260911151934   (the stamp IS the apply time, UTC: 2026-09-11 15:19:34)
--   name        the_register_correction_is_the_drift_the_next_snapshot_sees
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 4286 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260911151934 IS ALREADY IN
