...
-- Applied to production 20260911161027; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260911161027   (the stamp IS the apply time, UTC: 2026-09-11 16:10:27)
--   name        the_supply_meter_counts_the_tickets_it_issued
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 28431 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260911161027 IS ALREADY IN
...
--     TRIGGER        ab_ca_chip_store_declared
--     FUNCTION       public.fn_ca_ticket_escrow_float, public.fn_ca_supply_snapshot, public.fn_ca_chip_store_coverage_gaps, public.fn_ca_chip_store_declared, public.fn_ca_conservation_sweep
--     TABLE          public.ca_chip_store_coverage
--     DROP           TRIGGER ab_ca_chip_store_declared
--     RLS-ENABLE     
--
