...
-- Applied to production 20260912044158; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260912044158   (the stamp IS the apply time, UTC: 2026-09-12 04:41:58)
--   name        a_function_audited_as_moving_no_money_is_not_undeclared
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 2536 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260912044158 IS ALREADY IN
...
--     FUNCTION       public.fn_ca_undeclared_money_paths
--
