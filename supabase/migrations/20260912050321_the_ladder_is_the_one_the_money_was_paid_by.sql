...
-- Applied to production 20260912050321; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260912050321   (the stamp IS the apply time, UTC: 2026-09-12 05:03:21)
--   name        the_ladder_is_the_one_the_money_was_paid_by
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 4015 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260912050321 IS ALREADY IN
