...
-- Applied to production 20260912050353; the .sql file was never committed at the
...
--
-- LEDGER ROW
--   version     20260912050353   (the stamp IS the apply time, UTC: 2026-09-12 05:03:53)
--   name        a_money_adjacent_post_hand_failure_is_not_info
--   created_by  daniel@bekavactrading.com
--   statements  1 statement(s), 5893 bytes
--
-- WHY THE FILENAME VERSION WAS NOT RESERVED
--
-- CLAUDE.md 4.5 says never hand-pick a migration version and always run
-- scripts/new-migration.mjs. A mirror is the one sanctioned exception, and the
-- exception is what makes it safe: 20260912050353 IS ALREADY IN
...
--     FUNCTION       public.fn_ca_financial_alert_to_incident
--
