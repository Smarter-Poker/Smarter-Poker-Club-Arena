...
-- Applied to production 20260914070338; the .sql file was never committed at the
-- time (cached chip-statement boundary refusal; found by the two-way migration
-- diff of 2026-09-21). Content is byte-exact to what ran. Do NOT re-apply; it is
-- already live.
--
-- VERIFIED LIVE 2026-09-21 07:06:55 UTC: md5(pg_get_functiondef(
-- 'public.fn_ca_chip_statement(text,uuid,timestamptz,integer)')) =
-- 48dd7c1b2b828579f04a45b84a6a6eee, which is the later of the two hashes this
-- migration's own guard accepts and therefore its postimage.
--
-- WHAT IT DOES. A page opened before the cursor upgrade of 20260914060325 must
-- also refuse an ambiguous continuation, rather than silently resuming from a
-- timestamp that several legs share.
--
