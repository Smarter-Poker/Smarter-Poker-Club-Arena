...
-- money-trigger-ok: tournaments.non_satellite_completed_requires_terminal_receipt because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournaments.stamp_tournament_terminal_evidence_markers because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournaments.tournament_prize_math_contract because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournaments.trg_retire_manager_wakes_after_terminal_status because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournaments.zzzz_freeze_finalized_tournament_prize_pool because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournaments.zzzz_tournament_pool_finalization_window_guard because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournaments.zzzzy_lock_atomic_final_table_deal_status because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournaments.zzzzz_tournaments_atomic_final_table_deal_completion_guard because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: table_seats.a00_f06_source_seat because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: table_seats.terminal_tournament_seat_is_immutable because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: table_seats.trg_log_seat_stack_exit because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: table_seats.zzz_diamond_seat_keeps_custody because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournament_players.a00_f06_source_roster because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournament_players.terminal_tournament_evidence_is_immutable because This retained catalog string is compared for equality only; no trigger is created or altered here.
-- money-trigger-ok: tournament_players.zzzz_refuse_finalized_tournament_entry because This retained catalog string is compared for equality only; no trigger is created or altered here.
