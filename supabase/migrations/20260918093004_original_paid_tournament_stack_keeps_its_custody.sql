-- money-trigger-ok: accounting_tournament_fee_batches.accounting_tournament_fee_batches_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: accounting_tournament_fee_batches.accounting_tournament_fee_batches_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: accounting_tournament_fee_cutover.accounting_tournament_fee_cutover_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: accounting_tournament_fee_cutover.accounting_tournament_fee_cutover_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: accounting_tournament_fee_recognitions.accounting_tournament_fee_recognitions_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: accounting_tournament_fee_recognitions.accounting_tournament_fee_recognitions_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: accounting_tournament_fee_sources.accounting_tournament_fee_sources_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: accounting_tournament_fee_sources.accounting_tournament_fee_sources_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: accounting_tournament_recognized_sources.accounting_tournament_recognized_sources_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: accounting_tournament_recognized_sources.accounting_tournament_recognized_sources_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: ca_mtt_admission_contract.ca_mtt_admission_contract_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: ca_mtt_admission_contract.ca_mtt_admission_contract_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: chip_ledger.original_union_pnl_flow because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: chip_ledger.zz_tournament_accounting_credit_ledger because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: managed_game_contract_versions.trg_managed_game_contract_version_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: rake_records.accounting_cash_source_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: rake_records.accounting_tournament_fee_commit_capture because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: rake_records.accounting_tournament_fee_source_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: rake_records.accounting_tournament_recognized_evidence_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: rake_records.trg_award_vip_points_from_rake because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: table_seats.trg_ca_guard_seat_creation because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: table_seats.trg_seat_change_syncs_seat_first_count because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: table_seats.union_pnl_original_inventory because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: table_seats.union_pnl_original_inventory_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: table_seats.zz_freeze_entry_guard because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tables.trg_tables_capture_management_contract because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tables.trg_tables_emit_game_management_event because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tables.trg_tables_managed_lifecycle_guard because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tables.union_pnl_original_inventory because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tables.union_pnl_original_inventory_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_accounting_credit_receipts.original_evidence_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_accounting_credit_receipts.original_evidence_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_accounting_credit_receipts.original_union_pnl_frame because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_entry_close_receipts.aaa_require_satellite_economics_at_entry_close because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_launch_receipts.tournament_launch_receipt_is_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_obligation_events.original_evidence_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_obligation_events.original_evidence_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_obligation_events.original_union_pnl_frame because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_obligations.zz_tournament_accounting_obligation_event because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_participant_funding_receipts.original_evidence_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_participant_funding_receipts.original_evidence_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_participant_funding_receipts.original_union_pnl_frame because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_players.trg_enforce_tournament_capacity because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_players.union_pnl_original_inventory because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_players.union_pnl_original_inventory_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_players.zz_freeze_entry_guard because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_refund_entitlements.tournament_refund_entitlements_append_only because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_refund_tranches.original_union_pnl_frame because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_refund_tranches.tournament_refund_tranches_append_only because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_satellite_awards.tournament_satellite_awards_append_only because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_satellite_remainders.tournament_satellite_remainders_append_only because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_satellite_settlements.tournament_satellite_settlements_append_only because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_unregistration_receipts.tournament_unregistration_receipts_append_only because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournament_waitlists.tournament_waitlists_fixed_format_only because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.a0_tournaments_dual_entry_capacity because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.a1_tournaments_restart_source because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.a2_tournaments_new_satellite_target because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.tournaments_creation_guard because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.tournaments_new_mtt_blind_contract because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.tournaments_rank_before_complete because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.tournaments_short_formats_never_break because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.trg_tournaments_capture_management_contract because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.trg_tournaments_emit_game_management_event because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.trg_tournaments_managed_lifecycle_guard because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.union_pnl_original_inventory because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.union_pnl_original_inventory_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.zz_ca_fund_overlay_on_lock because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.zz_freeze_launch_guard because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: tournaments.zzzzzzz_tournaments_record_format because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: union_clubs.union_pnl_original_inventory because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: union_clubs.union_pnl_original_inventory_no_truncate because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: union_pnl_inventory_events.original_pnl_inventory_events_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: union_pnl_original_flows.original_pnl_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
-- money-trigger-ok: union_pnl_transaction_frames.original_pnl_immutable because this is an inert exact installed trigger identity inside the activation catalog proof; no trigger DDL is executed.
