...
-- WHAT THIS CHANGES, AND WHY (phase 5 deep dive, third pass, 2026-09-20):
--
-- THE DIAMOND ARENA IS DIAMONDS ONLY. NO CHIPS, EVER. (Dan, 2026-09-13.)
--
-- Read from the ledger after the previous map landed: the Diamond Spins
-- perks (throwables, time bank, rabbit hunt, 2026-09-19) are charged under
-- the bare kind `deduction` - "Diamond Spins: Throwables for <table>" - and
-- eight rows, 5,190 diamonds, sat in Other. They are store perks; `deduction`
-- is named exactly and files under Store Items And Perks. Same signature,
-- same callers; only the map is replaced. Recorded, not fixed here: that
-- writer should carry a perk kind, not `deduction`, and no table id in the
-- copy a player reads.
