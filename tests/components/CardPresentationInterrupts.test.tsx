...
describe('a table nobody can see does not animate (spec 47)', () => {
  ...
  it('and TablePage actually passes it - the off profile is reachable in production', () => {
    ...
    /* Imported at the top of the file, not require()d here. `no-require-imports`
       is an ERROR in this repo, so these two lines refused every commit that
       staged a sibling test - which is how a merge from main became unable to
       commit at all on 2026-09-05. */
