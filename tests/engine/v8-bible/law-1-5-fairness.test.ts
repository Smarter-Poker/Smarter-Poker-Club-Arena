...
describe('V8 Bible — 7.4: Side Pot Calculation', () => {
  it('correctly creates side pots with 3 all-in players at different amounts', () => {
    const players: SeatPlayer[] = [
      {
        seat: 1, user_id: 'p1', username: 'P1', avatar_url: '',
        stack: 0, bet: 0, totalInvested: 10, cards: [],
        is_folded: false, is_all_in: true, is_sitting_out: false,
      },
      {
        seat: 2, user_id: 'p2', username: 'P2', avatar_url: '',
        stack: 0, bet: 0, totalInvested: 30, cards: [],
        is_folded: false, is_all_in: true, is_sitting_out: false,
      },
      {
        seat: 3, user_id: 'p3', username: 'P3', avatar_url: '',
        stack: 0, bet: 0, totalInvested: 50, cards: [],
        is_folded: false, is_all_in: true, is_sitting_out: false,
      },
    ];
    ...
    const players: SeatPlayer[] = [
      {
        seat: 1, user_id: 'p1', username: 'P1', avatar_url: '',
        stack: 0, bet: 0, totalInvested: 50, cards: [],
        is_folded: false, is_all_in: false, is_sitting_out: false,
      },
      {
        seat: 2, user_id: 'p2', username: 'P2', avatar_url: '',
        stack: 0, bet: 0, totalInvested: 50, cards: [],
