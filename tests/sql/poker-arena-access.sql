...
INSERT INTO profiles VALUES ('10000000-0000-4000-8000-000000000001'),('10000000-0000-4000-8000-000000000002');
...
DO $$ DECLARE c jsonb; n bigint; BEGIN
 ...
 RAISE NOTICE 'PASS: Automatic membership, player role, unjoined Shark denial, unknown identity, table and tournament RLS (6)';
END $$;
RESET ROLE;
...
DO $$ DECLARE n bigint; BEGIN
 ...
 RAISE NOTICE 'PASS: Joined chip access, chip ownership preserved, Diamond ownership denied (3)';
END $$;
RESET ROLE;
...
END $$;
ROLLBACK;
\echo PHASE2_LOCAL_SQL_PASS_23_ASSERTIONS
