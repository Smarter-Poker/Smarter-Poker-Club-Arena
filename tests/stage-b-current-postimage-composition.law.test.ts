...
const contraction = stagedMigration('stage_b_current_postimage_contraction');
...
describe('Stage-B contraction preserves its exact bounded production prerequisites', () => {
  it('does not couple the boundary to unrelated later feature migrations or Final Deal RPCs', () => {
    for (const forbidden of [
      ...
      expect(contraction).not.toContain(forbidden);
    }
  });
