/**
 * ═══════════════════════════════════════════════════════════════════════════════
 *  THROWABLES INTEGRITY GUARD — the 52-item dynamic system must stay whole
 * ═══════════════════════════════════════════════════════════════════════════════
 *
 ...
 *
 *   1. THIS TEST (source level): the 52-item catalog, its per-item sound
...
describe('throwables integrity — 52-item dynamic system', () => {
  it('the catalog holds the 52 enabled items with local or storage artwork', () => {
  ...
  it('every item has its own sound recipe, and no recipe is orphaned', () => {
    ...
    expect(new Set(sounds).size).toBe(52); // one UNIQUE key per item
