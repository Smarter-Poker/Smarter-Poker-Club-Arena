/**
 * ═══════════════════════════════════════════════════════════════════════════════
 *  THROWABLES INTEGRITY GUARD — the 51-item dynamic system must stay whole
 * ═══════════════════════════════════════════════════════════════════════════════
 *
 ...
 *
 *   1. THIS TEST (source level): the 51-item catalog, its per-item sound
...
describe('throwables integrity — 51-item dynamic system', () => {
  it('the catalog holds the 51 enabled items with local or storage artwork', () => {
  ...
  it('every item has its own sound recipe, and no recipe is orphaned', () => {
    ...
    expect(new Set(sounds).size).toBe(51); // one UNIQUE key per item
