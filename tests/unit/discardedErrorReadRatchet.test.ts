...
const BASELINE = new Map<string, number>([
  ...
  ['src/services/ClubsService.ts', 6],
  ['src/services/PromotionService.ts', 5],
  ...
  ['src/services/AchievementTriggerService.ts', 2],
  ...
  ['src/services/PlayerNotesService.ts', 1],
  ...
  ['src/pages/PlayerStatsPage.tsx', 1],
  ['src/pages/PlayerStatisticsPage.tsx', 1],
  ...
  ['src/components/auth/ClubMemberGuard.tsx', 1],
