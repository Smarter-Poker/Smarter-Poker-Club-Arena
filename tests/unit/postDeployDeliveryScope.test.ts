...
// measured 507ms solo; vitest's 5s default is a unit-test budget and times
// out under the pre-push hook's 90-file parallel run. 90s is 178x measured,
// well above the worst contention amplification observed (7.1x).
describe(
  'post-publication verification belongs to its delivered component',
  { timeout: 90_000 },
  () => {
